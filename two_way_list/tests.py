...
from TwoWayList import LinkedList, Node
...
class TestLinkedList2OneItem(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s_list.add_tail(self.number)

    def test_one_item_check_head_tail_len_prev_next(self):
        self.assertEqual(self.s_list.size(), 1)
        self.assertEqual(self.s_list.head_cursor, self.s_list.tail_cursor)
        self.assertEqual(self.s_list.head_cursor.value, self.node.value)
        self.assertEqual(self.s_list.cursor, self.s_list.tail_cursor)
        self.assertEqual(self.s_list.cursor, self.s_list.head_cursor)
